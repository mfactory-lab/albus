...
const edBabyJubJub = {
   ...
   * @returns signature
   */
  async signPoseidon(key: Uint8Array, msg: Uint8Array): Promise<[Uint8Array, Uint8Array, Uint8Array]> {
    const eddsaBuild = await eddsaPromise
    ...
    return [bigIntToArray(sig.S, 32), r8[0], r8[1]]
  },

}

export { randomBytes, hash, edBabyJubJub }
