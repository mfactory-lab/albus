...
transfer.command('transfer')
  ...
  .requiredOption('-p, --proof-request <PROOF_REQUEST>', 'Proof request')
...
stake.command('authorize')
  ...
  .action(actions.verifiedStake.authorize)

stake.command('authorize-checked')
  .description('Authorize stake checked')
  .requiredOption('-p, --proof-request <PROOF_REQUEST>', 'Proof request')
  .requiredOption('-s, --stake <STAKE>', 'Stake address')
  .requiredOption('-n, --new-authorized <NEW_AUTHORIZED>', 'Path to new authorized keypair file')
  .requiredOption('-a, --authorized <AUTHORIZED>', '`w` for withdrawer authority, default - staker authority')
  .action(actions.verifiedStake.authorizeChecked)

stake.command('delegate')
  .description('Delegate stake')
  .requiredOption('-p, --proof-request <PROOF_REQUEST>', 'Proof request')
  .requiredOption('-s, --stake <STAKE>', 'Stake address')
  .requiredOption('-v, --vote <VOTE>', 'Vote account address')
  .action(actions.verifiedStake.delegate)

stake.command('merge')
  .description('Merge stake')
  .requiredOption('-p, --proof-request <PROOF_REQUEST>', 'Proof request')
  .requiredOption('-s, --source <SOURCE>', 'Source stake address')
  .requiredOption('-d, --destination <DESTINATION>', 'Destination stake address')
  .action(actions.verifiedStake.merge)

stake.command('redelegate')
  .description('Redelegate stake')
  .requiredOption('-p, --proof-request <PROOF_REQUEST>', 'Proof request')
  .requiredOption('-s, --stake <STAKE>', 'Stake address')
  .requiredOption('-v, --vote <VOTE>', 'Vote account address')
  .requiredOption('-n, --new-stake-path <NEW_STAKE_PATH>', 'Path to new stake keypair file')
  .action(actions.verifiedStake.redelegate)

stake.command('redelegate-with-seed')
  .description('Redelegate stake with seed')
  .requiredOption('-p, --proof-request <PROOF_REQUEST>', 'Proof request')
  .requiredOption('-st, --stake <STAKE>', 'Stake address')
  .requiredOption('-v, --vote <VOTE>', 'Vote account address')
  .requiredOption('-u, --uninitialized-stake <UNINITIALIZE_STAKE>', 'Uninitialized stake address')
  .requiredOption('-b, --base <BASE>', 'Path to base keypair file')
  .requiredOption('-s, --seed <SEED>', 'Seed')
  .action(actions.verifiedStake.redelegateWithSeed)

stake.command('split')
  .description('Split stake')
  .requiredOption('-p, --proof-request <PROOF_REQUEST>', 'Proof request')
  .requiredOption('-s, --stake <STAKE>', 'Source stake address')
  .requiredOption('-a, --amount <AMOUNT>', 'Amount of lamports to split of')
  .action(actions.verifiedStake.split)

stake.command('split-with-seed')
  .description('Split stake with seed')
  .requiredOption('-p, --proof-request <PROOF_REQUEST>', 'Proof request')
  .requiredOption('-st, --stake <STAKE>', 'Source stake address')
  .requiredOption('-a, --amount <AMOUNT>', 'Amount of lamports to split of')
  .requiredOption('-s, --seed <SEED>', 'Seed')
  .requiredOption('-b, --base <BASE>', 'Path to base keypair file')
  .action(actions.verifiedStake.splitWithSeed)
...
stake.command('withdraw')
  ...
  .requiredOption('-d, --destination <DESTINATION>', 'Lamports to')
  .action(actions.verifiedStake.withdraw)
...
stakePool.command('deposit-sol')
  ...
  .option('-k, --keypair <KEYPAIR>', 'Path to keypair of solDepositAuthority account')
...
stakePool.command('withdraw-sol')
  ...
  .requiredOption('-a, --amount <AMOUNT>', 'Amount of lamports to withdraw')
  .option('-k, --keypair <KEYPAIR>', 'Path to keypair of solWithdrawAuthority account')
