...
impl DeleteCredentialRequest {
  ...
  pub fn instruction_with_remaining_accounts(&self, remaining_accounts: &[solana_program::instruction::AccountMeta]) -> solana_program::instruction::Instruction {
    ...
    let data = DeleteCredentialRequestInstructionData::new().try_to_vec().unwrap();
...
pub struct DeleteCredentialRequestInstructionData {
            discriminator: [u8; 8],
      }

impl DeleteCredentialRequestInstructionData {
  pub fn new() -> Self {
    Self {
                        discriminator: [57, 4, 214, 165, 82, 70, 141, 240],
                  }
  }
}

impl Default for DeleteCredentialRequestInstructionData {
  fn default() -> Self {
    Self::new()
  }
}
...
/// Instruction builder for `DeleteCredentialRequest`.
///
/// ### Accounts:
///
...
pub struct DeleteCredentialRequestBuilder {
...
impl DeleteCredentialRequestBuilder {
  pub fn new() -> Self {
    Self::default()
  }
            #[inline(always)]
...
#[inline(always)]
  ...
  pub fn instruction(&self) -> solana_program::instruction::Instruction {
    let accounts = DeleteCredentialRequest {
  ...
  /// `delete_credential_request` CPI accounts.
  pub struct DeleteCredentialRequestCpiAccounts<'a, 'b> {
...
/// `delete_credential_request` CPI instruction.
pub struct DeleteCredentialRequestCpi<'a, 'b> {
...
impl<'a, 'b> DeleteCredentialRequestCpi<'a, 'b> {
  pub fn new(
    program: &'b solana_program::account_info::AccountInfo<'a>,
          accounts: DeleteCredentialRequestCpiAccounts<'a, 'b>,
          ) -> Self {
    Self {
      __program: program,
...
/// Instruction builder for `DeleteCredentialRequest` via CPI.
///
/// ### Accounts:
///
                ///   0. `[writable]` credential_request
          ...
          ///   2. `[]` system_program
#[derive(Clone, Debug)]
pub struct DeleteCredentialRequestCpiBuilder<'a, 'b> {
  instruction: Box<DeleteCredentialRequestCpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> DeleteCredentialRequestCpiBuilder<'a, 'b> {
  pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
    let instruction = Box::new(DeleteCredentialRequestCpiBuilderInstruction {
      __program: program,
  ...
  #[allow(clippy::vec_init_then_push)]
  pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program::entrypoint::ProgramResult {
        let instruction = DeleteCredentialRequestCpi {
...
#[derive(Clone, Debug)]
struct DeleteCredentialRequestCpiBuilderInstruction<'a, 'b> {
