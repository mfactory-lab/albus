...
impl VerifyProofRequest {
  ...
  pub fn instruction_with_remaining_accounts(&self, remaining_accounts: &[solana_program::instruction::AccountMeta]) -> solana_program::instruction::Instruction {
    ...
    let data = VerifyProofRequestInstructionData::new().try_to_vec().unwrap();
...
pub struct VerifyProofRequestInstructionData {
            discriminator: [u8; 8],
      }

impl VerifyProofRequestInstructionData {
  pub fn new() -> Self {
    Self {
                        discriminator: [134, 245, 92, 39, 75, 253, 56, 152],
                  }
  }
}

impl Default for VerifyProofRequestInstructionData {
  fn default() -> Self {
    Self::new()
  }
}
...
/// Instruction builder for `VerifyProofRequest`.
///
/// ### Accounts:
///
...
pub struct VerifyProofRequestBuilder {
...
impl VerifyProofRequestBuilder {
  pub fn new() -> Self {
    Self::default()
  }
            #[inline(always)]
...
#[inline(always)]
  ...
  pub fn instruction(&self) -> solana_program::instruction::Instruction {
    let accounts = VerifyProofRequest {
  ...
  /// `verify_proof_request` CPI accounts.
  pub struct VerifyProofRequestCpiAccounts<'a, 'b> {
...
/// `verify_proof_request` CPI instruction.
pub struct VerifyProofRequestCpi<'a, 'b> {
...
impl<'a, 'b> VerifyProofRequestCpi<'a, 'b> {
  pub fn new(
    program: &'b solana_program::account_info::AccountInfo<'a>,
          accounts: VerifyProofRequestCpiAccounts<'a, 'b>,
          ) -> Self {
    Self {
      __program: program,
...
/// Instruction builder for `VerifyProofRequest` via CPI.
///
/// ### Accounts:
///
                ///   0. `[writable]` proof_request
          ...
          ///   3. `[]` system_program
#[derive(Clone, Debug)]
pub struct VerifyProofRequestCpiBuilder<'a, 'b> {
  instruction: Box<VerifyProofRequestCpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> VerifyProofRequestCpiBuilder<'a, 'b> {
  pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
    let instruction = Box::new(VerifyProofRequestCpiBuilderInstruction {
      __program: program,
              proof_request: None,
              circuit: None,
              authority: None,
  ...
  #[allow(clippy::vec_init_then_push)]
  pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program::entrypoint::ProgramResult {
        let instruction = VerifyProofRequestCpi {
...
#[derive(Clone, Debug)]
struct VerifyProofRequestCpiBuilderInstruction<'a, 'b> {
