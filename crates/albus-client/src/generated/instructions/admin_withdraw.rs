...
impl AdminWithdraw {
  ...
  pub fn instruction_with_remaining_accounts(&self, remaining_accounts: &[solana_program::instruction::AccountMeta]) -> solana_program::instruction::Instruction {
    ...
    let data = AdminWithdrawInstructionData::new().try_to_vec().unwrap();
...
#[inline(always)]
  ...
  /// `admin_withdraw` CPI accounts.
  pub struct AdminWithdrawCpiAccounts<'a, 'b> {
...
impl<'a, 'b> AdminWithdrawCpi<'a, 'b> {
  pub fn new(
    program: &'b solana_program::account_info::AccountInfo<'a>,
          accounts: AdminWithdrawCpiAccounts<'a, 'b>,
          ) -> Self {
    Self {
      __program: program,
