    ...
    let accounts = CreatePolicy {
          ...
          let args = CreatePolicyInstructionArgs {
                                                              code: self.code.clone().expect("code is not set"),
                                                                  ...
                                                                  expiration_period: self.expiration_period.clone().expect("expiration_period is not set"),
                                                                  retention_period: self.retention_period.clone().expect("retention_period is not set"),
                                                                  rules: self.rules.clone().expect("rules is not set"),
                                    };
  ...
  pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program::entrypoint::ProgramResult {
          let args = CreatePolicyInstructionArgs {
                                                              code: self.instruction.code.clone().expect("code is not set"),
                                                                  ...
                                                                  expiration_period: self.instruction.expiration_period.clone().expect("expiration_period is not set"),
                                                                  retention_period: self.instruction.retention_period.clone().expect("retention_period is not set"),
                                                                  rules: self.instruction.rules.clone().expect("rules is not set"),
                                    };
