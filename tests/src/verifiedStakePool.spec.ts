...
//     })
//
//     const [proofRequest] = client.getProofRequestPDA(serviceProviderAddress, mint, payerKeypair.publicKey)
//
//     await client.prove({
//       proofRequest,
//       proof: getProofMock(),
//     })
//
//     await client.verify({ proofRequest })
//
...
//     })
//
//     const [ZKPRequestAddress] = client.getProofRequestPDA(serviceProviderAddress, mint, payerKeypair.publicKey)
//
//     try {
//       await verifiedStakePoolClient.addValidator({
//         stake: validatorStakeAccount,
